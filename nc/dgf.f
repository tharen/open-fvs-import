...
C----------
      IF(ISPC .NE. 2 .AND. ISPC .NE. 6 .AND. ISPC .NE. 9) THEN
C
...
C  CALCULATE REDWOOD DG
      ELSEIF(ISPC .EQ. 12) THEN
...
C CALCULATE DG FOR REMAINING SPECIES
      ELSE
