...
C----------
     ...
     &  2*20.0,50.0, 20.0,18.0,26.0,26.0,26.0,26.0,26.0,26.0,26.0,26.0,
     &  26.0,26.0,26.0/,
...
C----------
     ...
     & 'SS ',   'AF ',   'RA ',   'CW ',   'OH ',   'OS ',   'OS ',
     & 'OS ',   'OS ',   'OS ',   'OS ',   'OS ',   'OS ',   'OS ',
     & 'OS ',   'OS '/
C
      DATA FIAJSP /
     & '094',   '242',   '011',   '264',   '263',   '042',   '108',
     & '098',   '019',   '351',   '747',   '998',   '298',   '298',
     & '298',   '298',   '298',   '298',   '298',   '298',   '298',
     & '298',   '298'/
C
      DATA PLNJSP /
     & 'PIGL  ','THPL  ','ABAM  ','TSME  ','TSHE  ','CANO9 ','PICO  ',
     & 'PISI  ','ABLA  ','ALRU2 ','POBAT ','2TD   ','2TE   ','2TE   ',
     & '2TE   ','2TE   ','2TE   ','2TE   ','2TE   ','2TE   ','2TE   ',
     & '2TE   ','2TE   '/
C
...
C
     ...
     &'RA1','CW1','OH1','OS1','OS1','OS1','OS1','OS1','OS1','OS1','OS1',
     &'OS1','OS1','OS1','WS2','RC2','SF2','MH2','WH2','YC2','LP2','SS2',
     &'AF2','RA2','CW2',
     &'OH2','OS2','OS2','OS2','OS2','OS2','OS2','OS2','OS2','OS2','OS2',
     &'OS2','WS3','RC3','SF3',
...
C
      DATA HT1/ 9*0.0, 4.875, 5.152, 12*0.0 /
      DATA HT2/ 9*0.0, -8.639, -13.576, 12*0.0 /
C
...
C
     ...
     & 0.34599, 0.34599, 0.34599, 0.34599, 0.34599,
     & 0.34599, 0.34599, 0.34599, 0.34599, 0.34599/
C----------
...
C
     ...
     & 4.8945, 4.8945, 4.8945, 4.8945, 4.8945, 4.8945, 4.8945,
     & 4.8945, 4.8945, 4.8945,
     ...
     & 4.9727, 4.9727, 4.9727, 4.9727, 4.9727, 4.9727, 4.9727, 4.9727,
     & 4.9727, 4.9727/
     ...
     & 4.9727, 4.6060, 4.9727, 4.7666, 4.9013, 4.8028,
     & 4.6150, 4.9727, 4.9727, 0.0   , 0.0   , 4.8028, 4.9727,
     & 4.9727, 4.9727, 4.9727, 4.9727, 4.9727, 4.9727, 4.9727,
     & 4.9727, 4.9727, 4.9727,
     ...
     & 4.8753, 4.8753, 4.8753, 4.8753, 4.8753, 4.8753, 4.8753,
     & 4.8753, 4.8753, 4.8753,
...
c
     ...
     &  -6.8703,  -6.8703,  -6.8703,  -6.8703,  -6.8703,  -6.8703,
     *  -6.8703,  -6.8703,  -6.8703,  -6.8703,  -6.8703,
     ...
     *  -6.8703,  -6.8703,  -6.8703,  -6.8703,  -6.8703,
     ...
     &  -8.9697,  -8.9697,  -8.9697,  -8.9697,  -8.9697,  -8.9697,
     &  -8.9697,  -8.9697,  -8.9697,  -8.9697,  -8.9697/
C
     ...
     & -10.4921, -10.4921, -10.4921, -10.4921, -10.4921, -10.4921,
     & -10.4921, -10.4921, -10.4921, -10.4921, -10.4921,
     & -10.4921,  -7.6276, -10.4921, -11.8502,  -9.4649, -11.2306,
     & -10.4718, -10.4921, -10.4921,   0.0   ,   0.0   , -11.2306,
     & -10.4921, -10.4921, -10.4921, -10.4921, -10.4921, -10.4921,
     & -10.4921, -10.4921, -10.4921, -10.4921, -10.4921,
     ...
     & -10.4921, -10.4921, -10.4921, -10.4921, -10.4921/
C
      DATA BB0/ 9*0.0, 59.5864, 0.6192, 12*0.0 /
C
      DATA BB1/ 9*0.0, 0.7953, -5.3394, 12*0.0 /
C
      DATA BB2/ 9*0.0, 0.00194, 240.29, 12*0.0 /
C
      DATA BB3/ 9*0.0, -0.0007403, 3368.9, 12*0.0 /
C
      DATA BB4/ 9*0.0, 0.9198, 13*0.0 /
C
      DATA BB5/ MAXSP*0. /
C
      DATA BB6/ MAXSP*0. /
