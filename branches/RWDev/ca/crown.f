...
C----------
      ...
      REAL CRINT(1),CRDBH(1),CRHDR(1),CRRD(1),CRDQMD(1)
      REAL B1,B2,B3,B4,B5
      ...
      REAL BAPLT,QMDPLT,TPAPLT,RDEN,DBHLO,DBHHI,SDICS,SDICZ,XMAX
      REAL ZRD(MAXPLT)
      INTEGER IWHO
C
...
C----------
      ...
      IF(C .LT. 2.0) C=2.0
C----------
C LOAD RW/GS COEFFICIENTS BASED ON ISPC
C----------
...
C----------
   58 CONTINUE
      ...
      TPCT = PCT(I)
      TPCCF = PCCF(IITRE)
      CALL DUBSCR(ISPC,D,H,RDEN,QMDPLT,CR,TPCT,TPCCF)
...
C----------
C     RW/GS INTERCEPT COEFFICIENT
      DATA CRINT/-1.842864/

C     RW/GS DBH COEFFICIENT
      DATA CRDBH/0.007664/

C     RW/GS HEIGHT DIAMETER RATIO COEFFICIENT
      DATA CRHDR/0.487667/

C     RW/GS RELATIVE DENSITY COEFFICIENT
      DATA CRRD/0.823697/

C     RW/GS RELATIVE DIAMETER COEFFICIENT (DBH/QMD)
      DATA CRDQMD/-0.145448/
