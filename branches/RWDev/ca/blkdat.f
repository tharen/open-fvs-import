...
C----------
     ...
     &           1.0, 0.5, 1.0, 1.0, 0.3, 0.8, 1.0, 0.5, 1.0, 1.0,
     &           0.8, 1.0, 0.8, 1.0, 0.5, 0.8, 0.8, 0.5, 0.8, 0.5,
     &           0.8, 1.0, 0.5, 1.0, 1.2, 1.2, 1.0, 0.3, 0.5, 0.75 /
...
C    50 = COASTAL REDWOOD (RW)            SEQUIOA SEMPERVIRENS
C----------
      DATA JSP /
...
C
     ...
     & 0.4391, 0.6032, 0.4392, 0.4458, 0.5998, 0.5998, 0.5998,
