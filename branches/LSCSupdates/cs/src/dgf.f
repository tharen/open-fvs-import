      ...
      IMPLICIT NONE
C----------
C  **DGF--CS    DATE OF LAST REVISION:  01/17/2013
C----------
...
C  XXX-XXX WITH MICHIGAN TECHNOLOGICAL UNIVERSITY, OCTOBER 2012.
C----------
COMMONS
C
C
...
C----------      
      SELECT CASE (ISPC)
      CASE(7)                                ! WP
        IF(ICR(I).GT.50)ICR(I)=50
      CASE(8:10)                             ! WN,BN,TL
        IF(ICR(I).GT.75)ICR(I)=75
      CASE(28,41)                            ! EC,YP
        IF(ICR(I).GT.60)ICR(I)=60
      CASE(44:46)                            ! AS,WA,GA
        IF(ICR(I).GT.80)ICR(I)=80
