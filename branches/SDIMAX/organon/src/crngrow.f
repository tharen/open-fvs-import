...
C**********************************************************************
     ...
     4       AHCB1,SHCB1,AHCB2,SHCB2,MAXHCB,CC2,MINCR
...
C**********************************************************************
      ...
      IMPLICIT NONE
      INTEGER*4 VERSION,ISPGRP
      REAL*4 HLCW,LCW,HT,DBH,EXPAN,XL,CW,CWAPAR(18,3),B1,B2,B3,RP,RATIO
C
...
C**********************************************************************
      ...
      IMPLICIT NONE
      INTEGER*4 VERSION,ISPGRP
      REAL*4 HLCW,LCW,HT,DBH,EXPAN,XL,CW,CWAPAR(11,3),B1,B2,B3,RP,RATIO
C
C  CROWN WIDTH ABOVE LARGEST CROWN WIDTH (3 parameters - all species)
C
C     DF Coefficients from Hann (1999) FS 45: 217-225
...
C**********************************************************************
      ...
      IMPLICIT NONE
      INTEGER*4 VERSION,ISPGRP
      REAL*4 HLCW,LCW,HT,DBH,EXPAN,XL,CW,CWAPAR(7,3),B1,B2,B3,RP,RATIO
C
C  CROWN WIDTH ABOVE LARGEST CROWN WIDTH (3 parameters - all species)
C
C     RA Coefficients from Hann, Bluhm, and Hibbs Red Alder Plantation Analysis
...
C                = -1.0 TO SUBTRACT CUT TREES
     ...
     1          CC,DBH,HT,CR,CL,HCB,EXPAN,SCR1,MCW,LCW,DACB,HLCW
C
      DO L=1,40
         CCH(L)=0.
      ENDDO
