      ...
      IMPLICIT NONE
C----------
C CS $Id: sitset.f 1744 2016-03-28 21:01:34Z rhavis $
C----------
...
C----------
      DATA SDICON /354.,354.,490.,499.,480.,354.,529.,283.,
     & 283.,430.,704.,726.,430.,302.,302.,302.,230.,276.,
     & 302.,301.,301.,338.,289.,364.,423.,408.,408.,648.,
     & 421.,344.,590.,384.,282.,339.,420.,263.,282.,282.,
     & 227.,282.,478.,526.,371.,414.,408.,414.,361.,414.,
     & 342.,370.,315.,326.,336.,361.,423.,417.,311.,311.,
     & 417.,455.,405.,370.,384.,365.,342.,315.,342.,492.,
     & 492.,371.,492.,147.,338.,384.,520.,562.,343.,499.,
     & 499.,692.,433.,430.,447.,447.,257.,375.,422.,257.,
     & 463.,343.,404.,415.,492.,277.,304.,164./
...
C----------
      ...
      IF(SDIDEF(I) .LE. 0.) THEN
        ...
        ELSE
        	SDIDEF(I) = SDICON(I)
C         SDIDEF(I)=BAMAXA(I)/(0.5454154*(PMSDIU/100.))
        ENDIF
      ENDIF
   15 CONTINUE
C----------
