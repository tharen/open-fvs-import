...
C      ELSE
C  FOR THE CASE WHERE THERE ARE TREES BUT NO SDI, WHERE ALL TREES
C  ARE NOT AT LEAST 4.5 FT, SET MAX SDI TO DEFAULT SDIMAX
C
       ELSEIF((TEMD0.LE.0).AND.(TEMTPA.GT.0.))THEN
         TEMMAX=TEMTPA/UPMAX
       ELSE
         TEMMAX=0.
      ENDIF
      IF(TEMMAX.LE.0.)TEMMAX=0.
