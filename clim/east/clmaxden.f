      ...
      IMPLICIT NONE
C----------
C  $Id: clmaxden.f 1004 2013-08-01 16:04:44Z rhavis@msn.com $
C----------
C
C     CLIMATE EXTENSION 
C
...
C      PJR -- INTERPOLATE RSDI FROM ATTRIBUTE FILE AND RETURN
      MXDENMLT = ALGSLP (FIRSTYEAR,FLOAT(YEARS),ATTRS(1,NATTRS),NYEARS)
      XMAX = XMAX * MXDENMLT
      RETURN   

C     PJR -- UNREACHABLE CODE BELOW HERE FOR SOUTHERN VARIANT
      DO I=1,MAXSP
