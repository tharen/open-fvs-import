...
C      IF(DEBUG) WRITE(JOSTND,9070) I,D,RI,RN,RIP
C 9070 FORMAT('MORTALITY RATE ESTIMATES FOR TREE ',I4,', DBH = ',F6.2/
C     *' RI = ',F7.5,' RN = ',F7.5,' RIP = ',F7.5)

      IF(DEBUG) WRITE(JOSTND,9075) I,D,P,X,RIP
 9075 FORMAT('MORTALITY RATE ESTIMATES FOR TREE ',I4,', DBH = ',F6.2/
     *' P = ',F7.5,' X = ',F7.5,' RIP = ',F7.5)
      WK2(I)=WKI
C----------
...
C----------
   ...
   30 CONTINUE
     ...
     *'DQ10N,DR10N,DIA0= ',IPASS,DQ10,DR10,DQ10N,DR10N,DIA0
      IF(LZEIDE)THEN
        D10N=DR10N
      ELSE
        D10N=DQ10N
